...
class AdapterSchedulesEx(private val dataList: ArrayList<Project>) : RecyclerView.Adapter<AdapterSchedulesEx.ViewHolderData>() {
    ...
    fun updateDatas(newData: List<Project>) {
        dataList.clear()
